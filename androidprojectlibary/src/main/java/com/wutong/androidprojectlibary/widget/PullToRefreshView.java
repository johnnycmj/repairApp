...
/**
 * 修改了下滑导致点击事件被拦截（设置下滑y的灵敏度deltaYOffset）
 * @author Jolly
 * 创建时间：2013年12月18日下午1:42:44
 *
 */
public class PullToRefreshView extends LinearLayout {
	...
	private static int deltaYOffsetBase = 6;
	private static int deltaYOffset = 6;
	/**
	 * last y
	 */
	...
	private void init() {
		...
		deltaYOffset =(int) (deltaYOffsetBase * density);
	...
	private void addHeaderView() {
		// header view
		mHeaderView = mInflater.inflate(R.layout.widget_pull_to_refresh_header, this, false);
	...
	private void addFooterView() {
		// footer view
		mFooterView = mInflater.inflate(R.layout.widget_pull_to_refresh_footer, this, false);
	...
	public boolean onInterceptTouchEvent(MotionEvent e) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if(deltaY >= deltaYOffset || deltaY <= -deltaYOffset){
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if(deltaY >= deltaYOffset || deltaY <= -deltaYOffset){//设置灵敏度超过10才判断，否则交给子view
