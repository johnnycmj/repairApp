...
public class ChangeContactFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View fragmentView = inflater.inflate(R.layout.fragment_change_contact, container,false);
	...
	private void intentInit(){
		oldContact = this.getActivity().getIntent().getStringExtra("contact");
	}
	...
	private void submit(){
		...
		if(contact.toString().trim().length() == 0 || !isPhoneNumber(contact)){
