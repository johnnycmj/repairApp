...
public class NoticeListFragment extends BaseFragment {
	...
	private String noticeTitle = "公  告";
	...
	private void viewInit(){
		...
		mNoticeListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parentView, View view, int position,
					long noticeId) {
				if(position < mNoticeBeanList.size()){
	...
	private int selectedItemLayout(){
		switch (application.getSkinType()) {
		case 1:
			return R.layout.spring_horse_listview_notice_list;

		default:
			return R.layout.listview_notice_list;
		}
	}
	...
	private int selectedContentView(){
		switch (application.getSkinType()) {
		case 1:
			return R.layout.spring_horse_vp_av_index_tab_notice;

		default:
			return R.layout.vp_av_index_tab_notice;
		}
	}
}
