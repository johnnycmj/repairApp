...
public class RepairFragment extends BaseFragment {
		...
		titlebarFilterView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(filterDialog.isShowing()){
					...
					lp.x = 0;
					lp.y = getResources().getDimensionPixelOffset(R.dimen.common_titlebar_height_offset);
	...
	private void viewInit(){
		...
		if(application.hasPermission(getString(R.string.roles_permissions_function_repairman_repair_all))){
			notAcceptTipView.setText(R.string.label_repairman_empty_repair_order_collection_zero_tip_not_accept);
			//Fix分支
				((TextView)notAcceptPagerContentView.findViewById(R.id.footer_no_more_tip)).setText(R.string.label_repairman_footer_repair_order_collection_not_accept);
		}
		else{
			notAcceptTipView.setText(getString(R.string.tips_for_common_repair_order_empty));
			//Fix分支
				((TextView)notAcceptPagerContentView.findViewById(R.id.footer_no_more_tip)).setText(R.string.tips_for_not_accept_no_more);
		}
		...
		if(application.hasPermission(getString(R.string.roles_permissions_function_repairman_repair_all))){
			repairingTipView.setText(getString(R.string.label_repairman_empty_repair_order_collection_zero_tip_repairing));
			//Fix分支
				((TextView)repairingPagerContentView.findViewById(R.id.footer_no_more_tip)).setText(R.string.label_repairman_footer_repair_order_collection_repairing);
		}
		else{
			repairingTipView.setText(getString(R.string.tips_for_common_repair_order_empty));
			//Fix分支
				((TextView)repairingPagerContentView.findViewById(R.id.footer_no_more_tip)).setText(R.string.tips_for_repairing_no_more);
		}
		...
		if(application.hasPermission(getString(R.string.roles_permissions_function_repairman_repair_all))){
			finishTipView.setText(getString(R.string.label_repairman_empty_repair_order_collection_zero_tip_finish));
			//Fix分支
				((TextView)finnishPagerContentView.findViewById(R.id.footer_no_more_tip)).setText(R.string.label_repairman_footer_repair_order_collection_finish);
		}
		else{
			finishTipView.setText(getString(R.string.tips_for_common_repair_order_empty));
			//Fix分支
				((TextView)finnishPagerContentView.findViewById(R.id.footer_no_more_tip)).setText(R.string.tips_for_finish_no_more);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(convertView == null){
				...
				if(outIsLargeCharacter){
					convertView = LayoutInflater.from(mContext).inflate(selectedItemLayout(VIEW_CODE_NOT_ACCEPT,outIsLargeCharacter), null);
	...
	private class RepairOrderRepairingBaseAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(convertView == null){
				...
				if(outIsLargeCharacter){
					convertView = LayoutInflater.from(mContext).inflate(selectedItemLayout(VIEW_CODE_REPAIRING,outIsLargeCharacter), null);
					holder.assetView = (TextView) convertView.findViewById(R.id.repair_order_item_asset);
					holder.troubleView = (TextView) convertView.findViewById(R.id.repair_order_item_trouble);
				}
				else{
	...
	private class RepairOrderFinishBaseAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(convertView == null){
				...
				if(outIsLargeCharacter){
					convertView = LayoutInflater.from(mContext).inflate(selectedItemLayout(VIEW_CODE_FINISH,outIsLargeCharacter), null);
					holder.assetView = (TextView) convertView.findViewById(R.id.repair_order_item_asset);
					holder.troubleView = (TextView) convertView.findViewById(R.id.repair_order_item_trouble);
				}
				else{
	...
	private void asyncLoadRepairOrderHttp(RepairOrderPagerBean repairOrderPagerBean,final boolean isRefresh){
		...
		if(application.hasPermission(getString(R.string.roles_permissions_function_applicant_repair_all))){
			...
			case 0:
				if(dormRoomId == null || dormRoomId.toString().trim().length()== 0){
...
//					hideProgressDialog();
	...
	private boolean phoneInvalid(){
		...
		if(application.hasPermission(getString(R.string.roles_permissions_no_phone_no_access))){
			...
			if(phone == null ||phone.toString().trim().length() <11){
				...
				RepairFragment.this.getActivity().startActivity(intent);
				return true;
			}
		}
		return false;
	...
	private int selectedItemLayout(int viewCode,boolean isLarge){
		switch (application.getSkinType()) {
		case 1:
			switch (viewCode) {
			case VIEW_CODE_NOT_ACCEPT:
				return isLarge?R.layout.list_item_grid_repair_order_not_accept_large:R.layout.spring_horse_list_item_grid_repair_order_not_accept;
			case VIEW_CODE_REPAIRING:
				return isLarge?R.layout.list_item_grid_repair_order_repairing_large:R.layout.spring_horse_list_item_grid_repair_order_repairing;
			case VIEW_CODE_FINISH:
				return isLarge?R.layout.list_item_grid_repair_order_finish_large:R.layout.spring_horse_list_item_grid_repair_order_finish;
			default:
				break;
			}
			break;
		...
		default:
			switch (viewCode) {
			case VIEW_CODE_NOT_ACCEPT:
				return isLarge?R.layout.list_item_grid_repair_order_not_accept_large:R.layout.list_item_grid_repair_order_not_accept;
			case VIEW_CODE_REPAIRING:
				return isLarge?R.layout.list_item_grid_repair_order_repairing_large:R.layout.list_item_grid_repair_order_repairing;
			case VIEW_CODE_FINISH:
				return isLarge?R.layout.list_item_grid_repair_order_finish_large:R.layout.list_item_grid_repair_order_finish;
			default:
				break;
			}
			break;
	...
	private int selectedContentView(){
		switch (application.getSkinType()) {
		case 1:
			return R.layout.spring_horse_vp_av_index_tab_repair;

		default:
			return R.layout.vp_av_index_tab_repair;
		}
	}
}
