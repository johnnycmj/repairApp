...
public class PullToRefreshInvertView extends LinearLayout {
	...
	public PullToRefreshInvertView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public PullToRefreshInvertView(Context context) {
		super(context);
		init();
	}
	...
	private void addHeaderView() {
		// header view
		mHeaderView = mInflater.inflate(R.layout.refresh_invert_header, this, false);
	...
	private void addFooterView() {
		// footer view
		mFooterView = mInflater.inflate(R.layout.refresh_invert_footer, this, false);
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
			mHeaderTextView.setText(R.string.pull_to_refresh_invert_release_label);
			...
			mHeaderImageView.startAnimation(mFlipAnimation);
			// mHeaderImageView.
			mHeaderTextView.setText(R.string.pull_to_refresh_invert_pull_label);
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
			...
			mFooterTextView
					.setText(R.string.pull_to_refresh_invert_footer_release_label);
			...
			mFooterImageView.clearAnimation();
			mFooterImageView.startAnimation(mFlipAnimation);
			mFooterTextView.setText(R.string.pull_to_refresh_invert_footer_pull_label);
	...
	private void headerRefreshing() {
		...
		mHeaderTextView.setText(R.string.pull_to_refresh_invert_refreshing_label);
	...
	private void footerRefreshing() {
		...
		mFooterTextView
				.setText(R.string.pull_to_refresh_invert_footer_refreshing_label);
