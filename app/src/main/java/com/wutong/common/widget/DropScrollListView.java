 ...
 *
 */
public class DropScrollListView extends ListView implements OnScrollListener{
    ...
    public DropScrollListView(Context context) {
        this(context, null);
    }


    public DropScrollListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    void init(final Context context) {
        mHeaderLinearLayout = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.drop_down_refresh, null);
        ...
        mHeaderUpdateText.setText(context.getString(R.string.label_last_refresh, mSimpleDateFormat.format(new Date())));
    }
    ...
    private Handler mHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            case REFRESH_DONE:
                ...
                mHeaderPullDownImageView.setVisibility(View.VISIBLE);
                mHeaderReleaseDownImageView.setVisibility(View.GONE);
                mHeaderUpdateText.setText(getContext().getString(R.string.label_last_refresh, mSimpleDateFormat.format(new Date())));
                mHeaderLinearLayout.setPadding(mHeaderLinearLayout.getPaddingLeft(),
                        0,
                        mHeaderLinearLayout.getPaddingRight(),
                        mHeaderLinearLayout.getPaddingBottom());
